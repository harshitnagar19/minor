        ...
        <div className="min-h-screen bg-gray-900 text-white px-8 pb-8 pt-20 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="w-full max-w-3xl mb-12" data-aos="fade-up" data-aos-delay="100">
                        <div className="bg-gray-800 bg-opacity-50 p-8 rounded-lg shadow-xl backdrop-blur-sm">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button
                                    type="submit"
                                    className={`w-full py-3 px-6 rounded-md font-bold transition-all duration-300 ${submitStatus === 'sending'
                                ...
                                {submitStatus === 'success' && (
                                    <div className="mt-4 p-4 bg-green-800 bg-opacity-50 rounded-md text-center" data-aos="fade-up">
                    ...
                    <div className="w-full max-w-3xl">
                        <div className="flex flex-col md:flex-row md:space-x-6 space-y-8 md:space-y-0">
                            <div className="bg-gray-800 bg-opacity-50 p-8 rounded-lg shadow-xl md:w-1/2 backdrop-blur-sm" data-aos="flip-left" data-aos-delay="200">
                            ...
                            <div className="bg-gray-800 bg-opacity-50 p-8 rounded-lg shadow-xl md:w-1/2 backdrop-blur-sm" data-aos="flip-right" data-aos-delay="300">
                                <h2 className="text-2xl font-bold mb-6 border-b border-indigo-400 pb-4">Follow Us</h2>
                                <div className="flex space-x-4">
                                    <a href="#" className="bg-indigo-600 p-3 rounded-full hover:bg-indigo-500 transition-colors" data-aos="zoom-in" data-aos-delay="400">
                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"></path>
                                        </svg>
                                    </a>
                                    <a href="#" className="bg-indigo-600 p-3 rounded-full hover:bg-indigo-500 transition-colors" data-aos="zoom-in" data-aos-delay="500">
                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="#" className="bg-indigo-600 p-3 rounded-full hover:bg-indigo-500 transition-colors" data-aos="zoom-in" data-aos-delay="600">
                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="#" className="bg-indigo-600 p-3 rounded-full hover:bg-indigo-500 transition-colors" data-aos="zoom-in" data-aos-delay="700">
                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="mt-16 flex justify-center" data-aos="zoom-in" data-aos-delay="200">
